...
const router = useRouter()
  return (
    <section id="lands" className="w-full py-12 lg:py-24">
    <div className="container px-4 md:px-6">
      <div className="flex flex-col items-center justify-center space-y-4 text-center">
        <div className="space-y-2">
          ...
          Discover the vast expanse of this picturesque land,
           offering endless possibilities and untapped potential, 
          beckoning forth the visionary who seeks to shape their dreams upon its fertile soil.
          </p>
        </div>
      </div>
